...
export const sampleUpcomingTrips = [
  {
    id: 'trip1',
    city: 'Goa',
    date: '2024-04-15',
...
export const sampleRecommendedDestinations = [
  {
    id: 'dest1',
    city: 'Udaipur',
    state: 'Rajasthan',
...
export const sampleTopOffers = [
  {
    id: 'offer1',
    title: 'Summer Special: Manali Adventure',
    description: 'All-inclusive package with adventure activities',
    price: 24999,
    discount: 20,
    image: '/images/adventure/Manali Snow Trek.jpeg',
    validTill: '2024-05-31',
    perks: ['Hotel', 'Flights', 'Activities', 'Meals']
  },
  {
    id: 'offer2',
    title: 'Weekend Gateway: Goa Bliss',
    description: '3 nights package with water sports',
    price: 19999,
    discount: 15,
    image: '/images/adventure/Goa New Year Bash.png',
    validTill: '2024-04-30',
    perks: ['Beach Resort', 'Flights', 'Water Sports']
  },
  {
    id: 'offer3',
    title: 'Spiritual Journey: Golden Temple',
    description: 'Experience divine tranquility',
    price: 14999,
    discount: 10,
    image: '/images/religious/Golden Temple.jpg',
    validTill: '2024-06-15',
    perks: ['Hotel', 'Flights', 'Guide', 'Transfers']
  }
];
...
export const sampleBookings = [
  {
    ...
    details: {
      ...
      arrival: '08:15',
      passengers: [
        { name: 'John Doe', age: 28, seat: '12A' }
      ],
      class: 'Economy',
      baggage: '15 kg'
    },
    documents: {
      eTicket: '/tickets/TN78945.pdf',
      invoice: '/invoices/TN78945.pdf'
    }
  },
  {
    id: 'bk2',
    ...
    documents: {
      voucher: '/vouchers/TN78946.pdf',
      invoice: '/invoices/TN78946.pdf'
    }
  },
  {
    id: 'bk3',
    ...
    details: {
      ...
      duration: '5 days',
      inclusions: ['Hotel', 'Flights', 'Activities', 'Meals'],
      hotel: 'The Himalayan',
      flight: {
        onward: { airline: 'Air India', flightNo: 'AI-456' },
        return: { airline: 'Air India', flightNo: 'AI-457' }
      }
    },
    documents: {
      itinerary: '/itineraries/TN78947.pdf',
      invoice: '/invoices/TN78947.pdf'
    }
  },
  {
    id: 'bk4',
    ...
    details: {
      ...
      arrival: '12:20',
      passengers: [
        { name: 'John Doe', age: 28, seat: '14F' }
      ],
      class: 'Economy',
      baggage: '25 kg'
    },
    documents: {
      cancellation: '/cancellations/TN78948.pdf',
      refund: '/refunds/TN78948.pdf'
    }
  }
];

// Sample travel packages with realistic data
export const travelPackages = [
  {
    id: 1,
    title: "Manali Honeymoon Escape",
    destination: "Manali, Himachal Pradesh",
    duration: "5 Days / 4 Nights",
    price: "₹12,999",
    description: "Romantic getaway with snow-capped mountains, luxury stays, and private experiences.",
    image: "/images/adventure/Manali Snow Trek.jpeg",
    rating: 4.8,
    reviews: 124,
    inclusions: ["Hotel", "Meals", "Sightseeing", "Transfers"],
    activities: ["Snow Activities", "River Rafting", "Temple Visit"],
    category: "Honeymoon"
  },
  {
    id: 2,
    ...
    price: "₹9,499",
    description: "Sun, sand, and sea with beach activities, water sports, and vibrant nightlife.",
    image: "/images/adventure/Goa New Year Bash.png",
    rating: 4.6,
    reviews: 208,
    inclusions: ["Hotel", "Breakfast", "Sightseeing", "Transfers"],
    activities: ["Beach Hopping", "Water Sports", "Cruise"],
    category: "Beach"
  },
  {
    id: 3,
    ...
    duration: "7 Days / 6 Nights",
    price: "₹18,999",
    description: "Experience the heaven on earth with stunning landscapes, shikaras, and gardens.",
    image: "/images/religious/Golden Temple.jpg",
    rating: 4.9,
    reviews: 156,
    inclusions: ["Hotel", "Meals", "Sightseeing", "Transfers", "Shikara Ride"],
    activities: ["Gondola Ride", "Garden Visit", "Shikara Ride"],
    category: "Scenic"
  },
  {
    id: 4,
    ...
    duration: "6 Days / 5 Nights",
    price: "₹15,499",
    description: "Explore India's rich heritage through historic monuments, forts, and palaces.",
    image: "/images/religious/Ajmer & Pushkar.jpg",
    rating: 4.7,
    reviews: 189,
    inclusions: ["Hotel", "Breakfast", "Sightseeing", "Transfers"],
    activities: ["Taj Mahal Visit", "City Palace", "Qutub Minar"],
    category: "Heritage"
  },
  {
    id: 5,
    ...
    duration: "8 Days / 7 Nights",
    price: "₹22,999",
    description: "Serene backwaters, lush tea plantations, and Ayurvedic rejuvenation experiences.",
    image: "/images/religious/Buddhist Circuit.jpeg",
    rating: 4.8,
    reviews: 142,
    inclusions: ["Hotel", "Meals", "Sightseeing", "Transfers", "Houseboat Stay"],
    activities: ["Houseboat Cruise", "Tea Garden Visit", "Kathakali Show"],
    category: "Nature"
  },
  {
    id: 6,
    ...
    duration: "6 Days / 5 Nights",
    price: "₹25,499",
    description: "Crystal clear waters, pristine beaches, and thrilling water adventures.",
    image: "/images/adventure/A-Complete-Tour-Guide-for-Rafting-in-Rishikesh.webp",
    rating: 4.9,
    reviews: 112,
    inclusions: ["Hotel", "Breakfast", "Ferry Transfers", "Sightseeing"],
    activities: ["Scuba Diving", "Glass Bottom Boat", "Cellular Jail Visit"],
    category: "Beach"
  }
];
...
export const tourActivities = [
  {
    ...
    image: "/images/adventure/Paragliding-in-India_1438933021_5FIJFm.avif",
    rating: 4.8,
    reviews: 245,
    type: "Adventure",
    difficulty: "Moderate",
    ageLimit: "12+ years",
    included: ["Equipment", "Training", "Photos"],
  ...
  },
  {
    ...
    duration: "6 Hours",
    price: "₹2,499",
    description: "Camel rides, sand dune bashing, and traditional Rajasthani dinner under stars.",
    image: "/images/religious/Ajmer & Pushkar.jpg",
    rating: 4.6,
    reviews: 189,
    type: "Cultural",
    difficulty: "Easy",
    ageLimit: "All ages",
    included: ["Transfers", "Dinner", "Cultural Show"],
    languages: ["English", "Hindi"]
  },
  {
    id: 3,
    ...
    duration: "4 Hours",
    price: "₹999",
    description: "Discover hidden gems, historical sites, and street food in Old Delhi.",
    image: "/images/religious/Buddhist Circuit.jpeg",
    rating: 4.7,
    reviews: 156,
    type: "Cultural",
    difficulty: "Easy",
    ageLimit: "All ages",
    included: ["Guide", "Food Tastings", "Monument Entries"],
    languages: ["English", "Hindi"]
  },
  {
    id: 4,
    ...
    duration: "1 Hour",
    price: "₹2,999",
    description: "Soar through the skies with experienced pilots and witness breathtaking views.",
    image: "/images/adventure/OIP.jpeg",
    rating: 4.9,
    reviews: 312,
    type: "Adventure",
    difficulty: "Moderate",
  ...
  },
  {
    ...
    duration: "2 Hours",
    price: "₹1,299",
    description: "Witness the spiritual Ganga Aarti ceremony from a boat on the sacred river.",
    ...
    difficulty: "Easy",
    ageLimit: "All ages",
    included: ["Boat Ride", "Guide", "Offerings"],
    languages: ["English", "Hindi"]
  },
  {
    id: 6,
    ...
    duration: "3 Hours",
    price: "₹899",
    description: "Learn about exotic spices, their cultivation, and enjoy a traditional lunch.",
    image: "/images/adventure/Goa New Year Bash.png",
    rating: 4.5,
    reviews: 142,
    type: "Leisure",
    difficulty: "Easy",
    ageLimit: "All ages",
    included: ["Guide", "Lunch", "Spice Samples"],
