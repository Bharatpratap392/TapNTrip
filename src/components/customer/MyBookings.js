...
import { fetchUserBookings, updateBookingDate, cancelBooking } from '../../services/api';
import { 
        ...
        const mockBookings = [
          {
            ...
            status: 'confirmed',
            passengers: [
              { name: 'John Doe', age: 35, gender: 'Male', seatNo: '12A' },
              { name: 'Jane Doe', age: 32, gender: 'Female', seatNo: '12B' }
            ],
            paymentInfo: {
              amount: 9198,
              method: 'Credit Card',
          ...
          },
          {
            ...
            status: 'confirmed',
            passengers: [
              { name: 'John Doe', age: 35, gender: 'Male', seatNo: '15C' }
            ],
            paymentInfo: {
              amount: 5299,
              method: 'Net Banking',
          ...
          },
          {
            ...
            status: 'confirmed',
            passengers: [
              { name: 'John Doe', age: 35, gender: 'Male', seatNo: '18D' },
              { name: 'Jane Doe', age: 32, gender: 'Female', seatNo: '18E' },
              { name: 'Jimmy Doe', age: 10, gender: 'Male', seatNo: '18F' }
            ],
            paymentInfo: {
              amount: 13797,
              method: 'UPI',
          ...
          },
          {
            ...
            status: 'confirmed',
            passengers: [
              { name: 'John Doe', age: 35, gender: 'Male', seatNo: '22A' },
              { name: 'Jane Doe', age: 32, gender: 'Female', seatNo: '22B' }
            ],
            paymentInfo: {
              amount: 12450,
              method: 'Credit Card',
